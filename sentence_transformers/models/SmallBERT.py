...
class SmallBERT(nn.Module):
    ...
    """
    def __init__(self, model_name_or_path: str, config_dict: dict, max_seq_length: int = 128, do_lower_case: bool = True):
        ...
        preloaded_config = BertConfig.from_dict(config_dict)  # load config from opt
        self.bert = BertModel(preloaded_config)
    ...
    def load(input_path: str):
        ...
        return SmallBERT(model_name_or_path=input_path, **config)
