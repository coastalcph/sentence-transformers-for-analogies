...
class BDIEvaluator(SentenceEvaluator):
    """
    Evaluate a model based on its ability to induce bilingual disctionaries.
    """
    ...
    def __call__(self, model: 'SequentialSentenceEmbedder', output_path: str = None, epoch: int = -1,
        ...
        print("P@1:\t{:4f}\tP@5:\t{:4f}\tP@10:\t{:4f}".format(p_at_1, p_at_10, p_at_5))
        logging.info("P@1:\t{:4f}\tP@5:\t{:4f}\tP@10:\t{:4f}".format(p_at_1, p_at_10, p_at_5))
