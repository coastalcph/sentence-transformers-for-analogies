...
if __name__ == '__main__':
    #embeddings_path = '/image/nlp-datasets/wikidata/biggraph/wikidata_translation_v1.tsv'
    #pointers_path = '/image/nlp-datasets/wikidata/biggraph/wikidata_qcodes_pointers_v1.json'
    embeddings_path = '/home/mareike/PycharmProjects/wikidata/data/biggraph_small.tsv'
    pointers_path = '/home/mareike/PycharmProjects/wikidata/data/biggraph_small.pointers.json'
